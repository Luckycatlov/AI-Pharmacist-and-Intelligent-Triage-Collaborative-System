...
QWEN_API_KEY = os.getenv("QWEN_API_KEY", "sk-xBRwP0NV2i0fRRTy9a74Cf18196b4077A2Bd048bCe411bB9")
QWEN_MODEL = os.getenv("QWEN_MODEL", "myllm")

# 杏林模型配置
XINGLIN_BASE_URL = os.getenv("XINGLIN_BASE_URL", "https://ai.tcmcds.com/v1")
XINGLIN_API_KEY = os.getenv("XINGLIN_API_KEY", "sk-6V4vUePnPQu4fmRJ0232F622807f49E099Ae6e55A23354A7")
